...
scaleSongStateMachine:
	...
	MOV #0, 0(R1)		;note = 0
	CMP #0, R12		;state - 0  ; state is in R12
...
case0:
	MOV #261, 0(R1)		;note = 261 ; C
	JMP convert		;
case1:
	MOV #294, 0(R1)		;note = 294 ; D
	JMP convert		;
case2:
	MOV #330, 0(R1)		;note = 330 ; E
	JMP convert		;
case3:
	MOV #349, 0(R1)		;note = 349 ; F
	JMP convert		;
case4:
	MOV #392, 0(R1)		;note = 392 ; G
	JMP convert		;
case5:
	MOV #440, 0(R1)		;note = 440 ; A
	JMP convert		;
case6:
	MOV #494, 0(R1)		;note = 494 ; B
	JMP convert		;
case7:
	MOV #523, 0(R1)		;note = 523 ; C
	JMP convert		;
default:
	MOV #0, 0(R1)		;note = 0
	JMP end			;
